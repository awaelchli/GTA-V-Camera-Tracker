...
// Camera recording
bool featureRecordingCamera				=	false;
bool featureRecordingCameraUpdated		=	false;
...
void process_misc_menu()
{
	...
	static struct {
		...
		{"TRACK (F9)",			&featureRecordingCamera, &featureRecordingCameraUpdated }
	};
...
char* get_cam_track_output_filename()
{
	...
	strftime(buffer, 80, "camera-track-%Y-%m-%d-%H-%M-%S.txt", timeinfo);
